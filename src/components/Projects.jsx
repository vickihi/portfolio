...
const projects = [
  ...
  },
  {
    ...
    highlights: [
      'API integration — first to connect React frontend to Django Framework backend, establishing initial data flow.',
      'Project CRUD — implemented full CRUD functionality for project management.',
      'CRUD helper — developed a reusable utility to standardize API requests and reduce code duplication',
