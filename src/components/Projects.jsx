...
const projects = [
  {
    ...
    highlights: [ 
      ...
      'Product Browsing — Product list and search',
      'Review System — Upvote/Downvote on reviews with live vote count',
      'Follow-ups — UX/UI improvements, responsive design, code cleanup',
    ],
    demo: 'https://flowerstore-new.onrender.com/',
  ...
  },
  {
    ...
    highlights: [
      'Theme Architecture — Custom WordPress theme',
      'Content Management — Custom Post Types for classes and instructors',
      'Classes — Custom Taxonomies for classes filtering by type and level',
      'Blogs — Native WordPress features for blog filtering by category',
      'UI — Clean UI and responsive layout using Bootstrap with custom CSS',
    ],
  ...
  },
  {
    ...
    desc: `A collaborative full-stack issue tracking web application built with a React frontend and a Django REST API backend (provided). 
    ...
    highlights: [
      'API Integration — React frontend connected to Django backend',
      'Project CRUD — Full CRUD functionality for project management',
      'Reusable API Layer — Utility to standardize API requests and reduce duplication',
      'Component Refactor — Home page refactoring for maintainability and scalability',
    ],
    demo: '#',
